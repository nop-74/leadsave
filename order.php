...
const TOKEN = '2d05e182acf36ca09cd4feba48866bee'; // Replace it with your own from your personal account
...
function healthCheck()
{
    ...
    if ('2d05e182acf36ca09cd4feba48866bee' == TOKEN) {
        echo 'Ошибка: ТОКЕН зарегистрирован по умолчанию, вам необходимо заменить его на токен из вашего личного кабинета. <br>';
    }
...
function checkData($data)
{
    ...
    if (empty($data['token']) || '2d05e182acf36ca09cd4feba48866bee' == $data['token']) {
